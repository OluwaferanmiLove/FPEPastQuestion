...
function OnBoarding({navigation}) {
  ...
  return (
    ...
    <ImageBackground style={styles.main} source={require('../../assets/bg.png')}>
        ...
        <View style={{ marginTop: hp(80), alignItems: 'center', justifyContent: 'center', marginHorizontal: wp(25)}}>
          <Text style={styles.title}>Browse your department past question</Text>
        </View>
        <View style={styles.button}>
          ...
          <View style={{marginTop: hp(15)}}>
            <TouchableOpacity onPress={() => navigation.navigate('Login')}>
              <Text
                style={{color: colors.white, fontSize: wp(16)}}>
